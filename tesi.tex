...
\end{lstlisting}
    ...
    Per migliorare la qualità complessiva delle immagini passate alla fase di feature extraction,
    si sceglie di porre diversi livelli di filtraggio con relativi parametri soglia,
    un primo controllo viene effetuato sulla maschera generata, ovvero, se 
