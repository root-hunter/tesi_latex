...
\chapter{Introduzione}
  ...
  in uno scenario di cambiamento climatico sempre più allarmante [vedi IPCC], risulta ormai essenziale lo sviluppo di soluzioni basate sulla
  ...
  per studiare la presenza del delfino di Risso nel Golfo di Taranto, specie classificata come 'Minacciata' dalla Red List della IUCN \cite{lanfredi2021grampus}. 
